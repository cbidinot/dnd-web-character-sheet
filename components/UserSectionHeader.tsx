...
const UserSectionHeader: React.FC<{ toggleDropdownFocus: ()=>void, toggleDropdown: ()=>void, setUserSectionWidth: Dispatch<SetStateAction<number>>}> = (props) => {
    ...
    return (
        <div className={styles.userSectionHeader} onMouseEnter={props.toggleDropdown} onMouseLeave={props.toggleDropdown}
